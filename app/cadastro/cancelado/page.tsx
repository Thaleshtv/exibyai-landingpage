...
export const metadata: Metadata = {
  title: "Pagamento Cancelado | Exiby",
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="max-w-lg w-full">
          <div className="bg-white rounded-3xl shadow-2xl shadow-primary/10 border border-gray-100 overflow-hidden">
            <div className="bg-gradient-to-br from-orange-500 to-amber-600 p-8 text-center">
            ...
            <div className="p-8 text-center">
              <p className="text-muted-foreground mb-6">
                Não se preocupe! Você pode tentar novamente quando quiser. Seu cadastro foi salvo e você pode completar o pagamento a qualquer momento.
              </p>
